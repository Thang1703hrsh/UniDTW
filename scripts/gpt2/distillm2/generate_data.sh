#!/bin/bash
# ==============================================
# DistiLLM-2 Data Generation Script for GPT-2
# Generates teacher-student response pairs
# ==============================================

set -e

# Sử dụng thư mục hiện tại làm gốc nếu không truyền tham số
BASE_PATH=${1:-$(pwd)}

# =========================================================
# 1. SỬA LỖI THƯ VIỆN HỆ THỐNG (QUAN TRỌNG)
# =========================================================
# Fix lỗi: /lib/x86_64-linux-gnu/libstdc++.so.6: version `GLIBCXX_3.4.29' not found
# Bằng cách trỏ vào thư viện lib của môi trường Conda 'warp'
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/home/hungpv/miniconda3/envs/warp/lib

# =========================================================
# 2. QUẢN LÝ BỘ NHỚ GPU
# =========================================================
# Giúp tránh lỗi phân mảnh bộ nhớ (OOM) khi chạy lâu
export PYTORCH_CUDA_ALLOC_CONF=expandable_segments:True

# =========================================================
# 3. CẤU HÌNH MODEL
# =========================================================
# Teacher: GPT-2 XL (1.5B) đã Fine-tune (SFT)
TEACHER_MODEL="bachthetrollface/gpt2-1.5B-teacher-dolly"

# Student: GPT-2 Base (120M) khởi tạo (Init)
